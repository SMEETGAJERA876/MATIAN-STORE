          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a
                ...
                aria-label="Facebook"
                className="h-9 w-9 rounded-full bg-white/10 flex items-center justify-center text-cyan-200 hover:bg-[#0645B5] hover:text-white transition border border-white/20 shadow-2xs"
                title="Facebook"
              >
