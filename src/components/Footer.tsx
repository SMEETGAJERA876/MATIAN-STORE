            ...
            <div className="pt-3 space-y-2">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a
                  ...
                  aria-label="Facebook"
                  className="h-10 w-10 rounded-full bg-white/10 text-cyan-200 flex items-center justify-center hover:bg-[#0645B5] hover:text-white hover:scale-105 transition-all border border-white/25 shadow-sm"
                  title="Facebook"
                >
