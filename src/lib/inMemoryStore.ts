...
export const initialCoupons = [
  {
    id: "cpn_fest10",
    code: "FESTIVAL10",
    description: "Get 10% Extra Festival Discount on orders above ₹1,500",
  ...
  },
  {
    id: "cpn_super15",
    code: "SUPER15",
    description: "Get 15% Mega Discount on orders above ₹2,500",
    discountType: "percentage" as const,
    discountValue: 15,
    minSpend: 2500,
    minOrderAmount: 2500,
  ...
  },
  {
    id: "cpn_m20",
    code: "MATRIN20",
    description: "20% Welcome Discount on first order above ₹499",
    discountType: "percentage" as const,
    discountValue: 20,
    minSpend: 499,
    minOrderAmount: 499,
