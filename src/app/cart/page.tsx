                  ...
                  {paymentMethod === "upi" && (
                    <div className="rounded-2xl bg-gradient-to-b from-blue-50/60 to-white p-6 border border-blue-100/80 space-y-4 text-center">
                      <div className="flex flex-col items-center justify-center space-y-3">
                        ...
                        <div>
                          <h4 className="text-sm font-bold text-[#102A5C]">Instant Live UPI & Gateway Payment</h4>
                          <p className="text-xs text-slate-500 mt-1 max-w-md">
                            Click <strong className="text-[#0645B5]">Pay ₹{total} with Razorpay</strong> below to open the secure payment gateway. Pay seamlessly via Google Pay, PhonePe, Paytm, BHIM, or scan a live dynamic QR code.
                          </p>
                        </div>
                        ...
                        <p className="text-xs text-emerald-700 font-bold bg-emerald-50 px-4 py-2 rounded-xl border border-emerald-200/80 inline-flex items-center gap-1.5 mt-2">
                          ...
                          <span>100% Secure Merchant Payment via Razorpay Live Gateway</span>
                        </p>
                      </div>
                    </div>
                  )}
