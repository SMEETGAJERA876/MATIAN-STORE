...
import { ShoppingCart, CheckCircle2, Clock, Truck, FileText } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-slate-800 pb-5">
        ...
        <p className="text-xs text-slate-400 font-medium mt-1">
          Track, process, and manage customer orders and payment statuses
        </p>
      </div>
            ...
            <tbody className="divide-y divide-slate-800/60">
              {orders.map((ord) => (
                <tr key={ord.id} className="hover:bg-slate-800/40 transition">
                  ...
                  <td className="px-6 py-4 uppercase font-bold text-slate-400">{ord.paymentMethod}</td>
                  <td className="px-6 py-4">
